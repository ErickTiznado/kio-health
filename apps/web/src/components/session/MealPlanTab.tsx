...
export const MealPlanTab: FC = () => {
  ...
  return (
    <div className="h-full overflow-y-auto p-6 space-y-5">
      {/* ── Diet Plan Textarea ── */}
      <div className="bg-white rounded-3xl p-6 border border-gray-100/60 shadow-sm">
        <label
...
Notas adicionales...`}
          className="w-full min-h-[40vh] text-base leading-8 text-gray-700 resize-none border-none outline-none bg-transparent placeholder:text-gray-300 placeholder:leading-8"
      ...
      <div className="bg-white rounded-3xl p-6 border border-gray-100/60 shadow-sm">
        ...
        {!attachedFileName ? (
            ...
            className={`
              ...
              ${
                isDragOver
                  ...
                  : 'border-gray-200 hover:border-kio/50 hover:bg-gray-50/50'
              }
            `}
          >
            <div className="w-12 h-12 rounded-2xl bg-gray-100 flex items-center justify-center">
              <Upload
                size={20}
                className={isDragOver ? 'text-kanji' : 'text-gray-400'}
              />
            </div>
            <div className="text-center">
              <p className="text-sm font-semibold text-gray-600">
                Arrastra un archivo o{' '}
                <span className="text-kanji underline underline-offset-2">
                  selecciona
                </span>
              </p>
          ...
          <div className="flex items-center gap-3 bg-kio/5 rounded-2xl px-5 py-4 border border-kio/20">
            <div className="w-10 h-10 rounded-xl bg-kio/20 flex items-center justify-center shrink-0">
              <FileText size={18} className="text-kanji" />
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-gray-800 truncate">
                {attachedFileName}
              </p>
              <p className="text-[10px] text-gray-400">Listo para guardar</p>
            </div>
            <button
              type="button"
