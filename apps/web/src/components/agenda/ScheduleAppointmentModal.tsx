...
export function ScheduleAppointmentModal({ isOpen, onClose, initialDate }: ScheduleAppointmentModalProps) {
            ...
            <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
                ...
                <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Completa los datos de la sesión</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 overflow-y-auto">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={createMutation.isPending || !selectedPatientId || !startTime}
