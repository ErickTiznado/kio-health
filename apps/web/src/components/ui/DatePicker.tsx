        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="datepicker-portal-content w-[320px] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-slate-800 overflow-hidden"
            >
              {/* Header */}
