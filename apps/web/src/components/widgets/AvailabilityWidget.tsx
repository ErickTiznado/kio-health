    ...
    <div className="flex-1 p-8 lg:p-10">
      ...
      <div className="grid grid-cols-7 gap-3">
        ...
        {days.slice(0, 28).map((d, i) => {
          ...
          if (d.density === 'full') bgClass = 'bg-[#a855f7] text-white shadow-[0_4px_12px_rgba(0,0,0,0.1)]';
          ...
          return (
            <Tooltip
              ...
              content={
                <div className="w-max min-w-[120px] bg-gray-900 text-white text-[10px] rounded-2xl p-4 shadow-xl border border-white/10 flex flex-col items-center gap-2">
                  <div className="font-bold tracking-widest uppercase text-[9px] text-white/70 border-b border-white/10 pb-1 w-full text-center mb-1">{d.status}</div>
